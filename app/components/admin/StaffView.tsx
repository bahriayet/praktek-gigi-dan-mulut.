...
export default function StaffView({ users, onUpdateRole }: StaffViewProps) {
  return (
    <motion.div
            ...
            <div key={u.id} className="py-2.5 space-y-2.5">
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0 flex-1">
                  <p className="text-sm font-bold text-slate-800 dark:text-slate-100 truncate transition-colors">{u.displayName || 'User Tanpa Nama'}</p>
                  ...
                  <td className="py-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="min-w-0">
                        <p className="text-sm font-bold text-slate-800 dark:text-slate-100 transition-colors">{u.displayName || 'User Tanpa Nama'}</p>
                        <p className="text-[10px] text-slate-500 dark:text-slate-400 break-all transition-colors">{u.email}</p>
                      </div>
                    </div>
                  </td>
